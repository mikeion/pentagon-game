...
export default function CampaignPage() {
  ...
  const { getChapterProgress, isLoaded } = useCampaignProgress();
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        >
          {campaignChapters.map((chapter, index) => {
            const progress = isLoaded ? getChapterProgress(chapter.id, chapter.levels.length) : null;
            ...
            return (
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                onClick={() => router.push(`/campaign/${chapter.id}`)}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 text-sm">
                      <span className="text-slate-500">{chapter.levels.length} levels</span>
                      {progress && (
                        <>
